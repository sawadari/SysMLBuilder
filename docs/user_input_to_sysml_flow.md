...
### 手順 5. lint と benchmark を必要に応じて更新する
...
このリポジトリの現在の実装は、まだ完全な profile-driven 実装ではありません。

つまり、YAML だけ変えても次が自動で動くとは限りません。

- [parser.py](C:/Users/sawad/OneDrive/ドキュメント/dev/SysMLBuilder/src/sysml_builder/parser.py)
- [transformer.py](C:/Users/sawad/OneDrive/ドキュメント/dev/SysMLBuilder/src/sysml_builder/transformer.py)
- [renderer.py](C:/Users/sawad/OneDrive/ドキュメント/dev/SysMLBuilder/src/sysml_builder/renderer.py)

いまの段階では、profile を更新したら実装側も必要に応じて更新してください。
