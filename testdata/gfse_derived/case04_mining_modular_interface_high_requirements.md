...
## Requirements
- REQ-MFI-001: The hull shall provide a typed HighSlot interface to a mining laser module.
- REQ-MFI-002: The HighSlot interface shall transfer power and activation command from the hull to the mining laser module.
