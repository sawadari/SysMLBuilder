# case05_mining_usecase_medium Cameo Display Guide
...
### `.sysml`
- `expected_en_canonical.sysml`
- `expected_en_review_overlay.sysml`
- `expected_ja_canonical.sysml`
- `expected_ja_review_overlay.sysml`
- `generated_en_canonical.sysml`
- `generated_en_review_overlay.sysml`
- `generated_ja_canonical.sysml`
- `generated_ja_review_overlay.sysml`

### `.yaml`
- `case05_mining_usecase_medium_syntax.yaml`
- `expected_en_contracts.yaml`
- `expected_en_projection_manifest.yaml`
- `expected_ja_contracts.yaml`
- `expected_ja_projection_manifest.yaml`
- `generated_en_contracts.yaml`
- `generated_en_projection_manifest.yaml`
- `generated_ja_contracts.yaml`
- `generated_ja_projection_manifest.yaml`
...
- `*_review_overlay.sysml`: 情報不足や曖昧さがある箇所を確認する
